  ...
  return (
    <footer className="py-6 px-16 border-t border-gray-200 font-light flex flex-col lg:flex-row justify-between items-center">
      <p className="text-gray-700 mb-6 lg:mb-0">
        Nguyễn Hữu Lộc {new Date().getFullYear()}
        <a
          href="facebook.com/locdev2000"
          target="_blank"
          rel="noreferrer"
          className="text-light-blue-500 no-underline hover:text-light-blue-700"
        >
          Facebook
        </a>
      </p>
      ...
      <ul className="list-unstyled flex">
        <li className="mr-6">
          <a
            className="text-gray-700 no-underline hover:text-gray-900 font-medium block text-sm"
            target="_blank"
            rel="noreferrer"
