...
import { GET_SCIENCE } from "../../contants/scienceContant";

function Science({ science, setShowModalUpdate, setShowModalDelete }) {
  const updateRef = React.useRef();
  const deleteRef = React.useRef();
  const dispatch = useDispatch();
  const handleUpdate = () => {
    dispatch({ type: GET_SCIENCE, payload: science });
