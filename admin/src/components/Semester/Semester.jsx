...
import { GET_SEMESTER } from "../../contants/semesterContant";

function Semester({ semester, setShowModalUpdate, setShowModalDelete }) {
  const updateRef = React.useRef();
  const deleteRef = React.useRef();
  const dispatch = useDispatch();
  const handleUpdate = () => {
    dispatch({ type: GET_SEMESTER, payload: semester });
